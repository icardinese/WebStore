/* Blur Text Fade-In Animation */
window.onload = function() {
    const pArray = document.querySelectorAll('.card p');
    pArray.forEach((p) => {
        let wordDelay = 0;

        const words = p.innerHTML.split(' ');

        // Clear the paragraph content for word wrapping
        p.innerHTML = '';

        // Wrap each word in a span and apply the fade-in animation with delays
        words.forEach((word, index) => {
            const span = document.createElement('span');
            span.innerHTML = word;
            span.style.animation = `fadeInWord 1.5s forwards ${wordDelay}s`; /* Increased animation duration */
            p.appendChild(span);
            ...
            wordDelay += 0.1; // Delay each word by 0.1s
        });
    });
    // The delay for the word animation
};
/* Blur Text Fade-In Animation */

/* This is for the pixels that are alive animation */
//This is an outdated version. You can find the improved and optimized version here: https://www.isladjan.com/work/3/quotes/ and here: https://github.com/isladjan/particles-playground

//Author: isladjan - https://isladjan.com/

gsap.registerPlugin(SplitText);

// This is for the page specific elements that will be activated/deactivated as the next page gets created
const pageItems = document.querySelectorAll(".Alive-Pixel-Slide");
pageItems.forEach((page, index) => {
    if (index !== 0) {
        page.disable = true;
        page.classList.add('disabled-overlay');
    }
});
...
(function initThree() {
    ...
    Promise.all([
        webgl.texture, // This is the initial image being loaded in index 0
        loadAsync("https://cdn.shopify.com/videos/c/o/v/9c7deb59fd0e4021b38252302a6d902f.mp4"), // index 1
        // webgl.loader.load('https://i.ibb.co/4RWFQtT/3.jpg'), // index 2
        // loadAsync("https://i.imgur.com/FyHLAY8.mp4"), // index 3
        // webgl.loader.load('https://i.ibb.co/RjjfRYn/4.jpg'), // index 4
        // webgl.loader.load('https://i.ibb.co/wzXGCjc/5.jpg'), // index 5
        // webgl.loader.load('https://i.ibb.co/CvFkkt5/6.jpg'), // index 6
        // webgl.loader.load('https://i.ibb.co/dMyyJRf/7.jpg'), // index 7
        // webgl.loader.load('https://i.ibb.co/0B8zcfx/8.jpg'), // index 8
        // webgl.loader.load('https://i.ibb.co/0FJ11K8/9.jpg'), // index 9
        // webgl.loader.load('https://i.ibb.co/m0623ht/10.jpg'), // index 10
        // webgl.loader.load('https://i.ibb.co/NZG7sTH/11.jpg'), // index 11
        // webgl.loader.load('https://i.ibb.co/n0mP4YD/12.jpg'), // index 12
        // loadAsync("https://i.imgur.com/8v7cwEB.mp4"), // index 13
        // webgl.loader.load('https://i.ibb.co/DktpY1G/13.jpg'), // index 14
        // webgl.loader.load('https://i.ibb.co/YhD5x95/14.jpg'), // index 15
        // loadAsync("https://i.imgur.com/CltKjqc.mp4"), // index 16
        // webgl.loader.load('https://i.ibb.co/99kssL1/15.jpg'), // index 17
        // loadAsync("https://i.imgur.com/xFaOgpw.mp4"), // index 18
        // loadAsync("https://i.imgur.com/FOnGfth.mp44"), // index 19
        // loadAsync("https://i.imgur.com/RxoPTCO.mp4"), // index 20
        // webgl.loader.load('https://i.ibb.co/FX4bL6Z/16.jpg'), // index 21
        // loadAsync("https://i.imgur.com/0mT1FdC.mp4"), // index 22
        // webgl.loader.load('https://i.ibb.co/KNv9Sk0/17.jpg'), // index 23
        // webgl.loader.load('https://i.ibb.co/26jn4mf/18.jpg'), // index 24
        // webgl.loader.load('https://i.ibb.co/BGhZSPY/19.jpg'), // index 25
        // webgl.loader.load('https://i.ibb.co/khHC166/20.jpg'), // index 26
        // loadAsync("https://i.imgur.com/Bm7WdGD.mp4"), // index 27
        // loadAsync("https://i.imgur.com/eC1nmy0.mp4"), // index 28
        // loadAsync("https://i.imgur.com/N0XnaNd.mp4"), // index 29
        // webgl.loader.load('https://i.ibb.co/Z8jb7zk/21.jpg'), // index 30
        // loadAsync("https://i.imgur.com/uxaxWKi.mp4"), // index 31
        // loadAsync("https://i.imgur.com/ijKZXbr.mp4"), // index 32
        // loadAsync("https://i.imgur.com/Cw3BCnG.mp4"), // index 33
    ]).then(result => {
    ...
    webgl.texturesOptions = [
        { index: 0, texture: "image", quote: '“Quality isn’t <span style="color:#666666">universal</span> so choose <em>wisely</em>.”', threshold: 20, random: 4.0, depth: 30.0, size: 1.7, square: 0 },
        { index: 1, texture: "video", quote: 'MAKTREK® Bi-Pass Technology <span style="color:#f4852a">shields</span> probiotics from stomach acid,<br>ensuring maximum live bacteria survive to colonize the intestines.', threshold: 60, random: 2.0, depth: 4.0, size: 1.5, square: 0 },
...
function changeTexture(e) {
    ...
    if (webgl.textureIndex !== 0) {
        pageItems[webgl.textureIndex-1].disable = true;
        pageItems[webgl.textureIndex].disable = false;
        pageItems[webgl.textureIndex-1].classList.add('disabled-overlay');
        pageItems[webgl.textureIndex].classList.remove('disabled-overlay')
    }
    else {
        pageItems[webgl.texturesOptions.length-1].disable = true;
        pageItems[webgl.textureIndex].disable = false;
        pageItems[webgl.texturesOptions.length-1].classList.add('disabled-overlay');
        pageItems[webgl.textureIndex].classList.remove('disabled-overlay')
    }
    console.log(webgl.textureIndex);
    console.log(webgl.texturesOptions.length);
